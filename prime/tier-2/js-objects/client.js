...
// create a function that takes in array of penguins
...
console.log('Our favorites are ', myCuties);
...
const FunnyTopHat = new Hat('Funny','Rebeccapurple',100);
const LargeTopHat = new Hat('Top','Grey',200);

console.log(averageTopHat);
console.log(FunnyTopHat);
console.log(LargeTopHat);
